...
function Model() {
  return (
    <div className="flex flex-col md:flex-row justify-center h-96 py-8 px-32 bg-rose-400 mt-28">
                    <div className="w-full md:w-1/2 p-4">
                        <img src="/model.jpg" alt="Woman wearing glasses" className="w-[510px] h-96" />
                        <div className="mt-4 relative bottom-36 left-10">
                    ...
                    <div className="w-full md:w-1/2 p-4">
                        ...
                        <button className="mt-6 bg-rose-300 text-gray-900 font-semibold py-2 px-4 rounded-lg flex items-center shadow-lg">
