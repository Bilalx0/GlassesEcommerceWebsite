...
import image1 from '/pic-5.jpg'

function Header() {
  return (
    <div>
    <Navbar></Navbar>
    <div className="flex flex-col md:flex-row items-center justify-between py-16 px-14 rounded-lg shadow-lg">
        <div className="text-left md:w-1/2">
            ...
            <div className="mt-8 flex items-center">
                <button className="bg-black text-white px-6 py-3 rounded-lg mr-4">Start Shopping</button>
                <button className="flex items-center text-black px-6 py-3 rounded-lg border border-black">
                    Explore More
        ...
        <div className="relative mt-8 md:mt-0 md:ml-8">
            <img src={image1} alt="Sunglasses on a yellow background" className="rounded-2xl h-auto" />
