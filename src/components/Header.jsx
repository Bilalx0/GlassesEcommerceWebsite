    ...
    <div className="flex flex-col md:flex-row items-center justify-between py-16 px-24">
        <div className="text-left md:w-1/2">
            ...
            <div className="mt-8 flex items-center">
                <button className="bg-rose-300 font-medium text-black px-6 py-3 rounded-lg mr-4">Start Shopping</button>
                <button className="flex items-center font-medium text-black px-6 py-3 rounded-lg border-2 border-rose-300">
                    Explore More
